...
public class Garden {
    ...
    public void startDigging() throws InterruptedException{ 
        lock.lock();
        try{
            while( (totalHolesDugByNewton()-totalHolesDugByNewton()) > 4 )
    ...
    * invoked on the garden class. */
    public int totalHolesDugByNewton() { return dugHoles; }
    public int totalHolesSeededByBenjamin() { return seededHoles; }
    public int totalHolesFilledByMary() { return filledHoles; }
}
